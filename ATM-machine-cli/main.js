...
if (pinAnswer.pin === myAccountPin) {
    ...
    if (operationAns.operations === "withdraw") {
        ...
        if (amountAns.amount < myAccountBalance) {
            ...
            console.log(chalk.bgCyanBright.bold(`Now your balance is: ${myAccountBalance}`));
        }
        else {
        ...
        console.log(chalk.bgYellowBright.bold(`Your current balance is ${myAccountBalance}`));
    }
        ...
        if (fastCash.fast_option === "1000") {
            ...
            console.log(chalk.hex(" #e75480")(`Your remaining Balance is ${myAccountBalance}`));
        }
